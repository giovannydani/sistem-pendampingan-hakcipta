        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 form-group">
                        <select class="form-select" wire:model="country_id" id="country_id">
                    ...
                    {{-- district --}}
                    <div wire:ignore.self class="col-md-4" id="district_label_creator">
                        <label class="mt-2">Kota *</label >
                    </div>
                    <div wire:ignore.self class="col-md-12 form-group" id="district_input_creator">
                        <div class="input-group mb-3">
                    ...
                    {{-- @if ($country_id == '8d1458c5-dde2-3ac3-901b-29d55074c4ec') --}}
                    {{-- Provinsi --}}
                    <div wire:ignore.self class="col-md-4 ina" id="province_id_label_creator">
                        <label class="mt-2" >Provinsi *</label >
                    </div>
                    <div wire:ignore.self class="col-md-12 form-group ina" id="province_id_input_creator">
                    ...
                    {{-- Kota --}}
                    <div wire:ignore.self class="col-md-4 ina" id="district_id_label_creator">
                        <label class="mt-2" >Kota *</label >
                    </div>
                    <div wire:ignore.self class="col-md-12 form-group ina" id="district_id_input_creator">
                    ...
                    {{-- Kecamatan --}}
                    <div wire:ignore.self class="col-md-4 ina" id="subdistrict_id_label_creator">
                        <label class="mt-2" >Kecamatan *</label >
                    </div>
                    <div wire:ignore.self class="col-md-12 form-group ina" id="subdistrict_id_input_creator">
