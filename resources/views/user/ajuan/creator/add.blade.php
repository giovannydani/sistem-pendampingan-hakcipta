...
@section('page-title', 'Tambah Pencipta')

@section('content')
<div class="page-heading">
  <h3>Tambah Pencipta</h3>
</div>
<div class="page-content">
    <section class="section">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.ajuan.pencipta.store', ['detailHakcipta' => $detailHakcipta->id]) }}" method="POST" class="form form-horizontal" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
