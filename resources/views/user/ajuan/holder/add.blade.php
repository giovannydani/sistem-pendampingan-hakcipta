...
@section('page-title', 'Tambah Pemegang Hakcipta')

@section('content')
<div class="page-heading">
  <h3>Tambah Pemegang Hakcipta</h3>
</div>
<div class="page-content">
    <section class="section">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.ajuan.pemegang.store', ['detailHakcipta' => $detailHakcipta->id]) }}" method="POST" class="form form-horizontal" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <h5 class="mb-4">Data Pemegang</h5>
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="input-group mb-3">
                                        <input type="text" id="no_telp" class="form-control" name="no_telp" placeholder="No Telepon" value="{{ old('no_telp') }}">
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <h5 class="mb-4">Alamat Pemegang</h5>
                                ...
                                <div class="col-md-8 form-group">
                                    <textarea name="address" id="address" rows="3" placeholder="Alamat" class="form-control">{{old('address')}}</textarea>
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="input-group mb-3">
                                        <input type="text" id="postal_code" class="form-control" name="postal_code" placeholder="Kode Pos" value="{{ old('postal_code') }}">
                                    </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <input class="form-check-input" type="checkbox" id="is_company" name="is_company" @checked(old('is_company'))>
...
<script>
    ...
    var selected_subdistrict = "{{ old('subdistrict_id') }}";
