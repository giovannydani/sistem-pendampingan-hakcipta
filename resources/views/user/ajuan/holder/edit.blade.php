...
@section('page-title', 'Edit Pemegang hakcipta')

@section('content')
<div class="page-heading">
  <h3>Edit Pemegang hakcipta</h3>
</div>
<div class="page-content">
    <section class="section">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('user.ajuan.pemegang.update', ['detailHakcipta' => $detailHakcipta->id, 'holderHakcipta' => $holderHakcipta->id]) }}" method="POST" class="form form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="input-group mb-3">
                                        <input type="text" id="name" class="form-control" name="name" placeholder="Nama" value="{{ old('name', $holderHakcipta->name) }}">
                                    </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="input-group mb-3">
                                        <input type="email" id="email" class="form-control" name="email" placeholder="Email" value="{{ old('email', $holderHakcipta->email) }}">
                                    </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="input-group mb-3">
                                        <input type="text" id="no_telp" class="form-control" name="no_telp" placeholder="No Telepon" value="{{ old('no_telp', $holderHakcipta->no_telp) }}">
                                    </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <select class="form-select" name="nationality_id" id="nationality_id">
                                        ...
                                        <option value="{{$kewarganegaraan->id}}" @selected(old('nationality_id', $holderHakcipta->nationality_id) == $kewarganegaraan->id)>{{$kewarganegaraan->name}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <h5 class="mb-4">Alamat Pemegang hakcipta</h5>
                                ...
                                <div class="col-md-8 form-group">
                                    <textarea name="address" id="address" rows="3" placeholder="Alamat" class="form-control">{{old('address', $holderHakcipta->address)}}</textarea>
                                ...
                                <div class="col-md-8 form-group">
                                    <select class="form-select" name="country_id" id="country_id" onchange="countryFuncAction()">
                                        ...
                                        @foreach ($kewarganegaraans as $kewarganegaraan)
                                        <option value="{{$kewarganegaraan->id}}" @selected(old('country_id', $holderHakcipta->country_id) == $kewarganegaraan->id)>{{$kewarganegaraan->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-8 form-group" id="province_id_input">
                                    <select class="form-select" name="province_id" id="province_id" onchange="provinceFuncAction()">
                                        ...
                                        <option value="{{$provinsi->id}}" @selected(old('province_id', $holderHakcipta->province_id) == $provinsi->id)>{{$provinsi->name}}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-8 form-group" id="district_input">
                                    <div class="input-group mb-3">
                                        <input type="text" id="district" class="form-control" name="district" placeholder="Kota" value="{{ old('district', $holderHakcipta->district) }}">
                                    </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <div class="input-group mb-3">
                                        <input type="text" id="postal_code" class="form-control" name="postal_code" placeholder="Kode Pos" value="{{ old('postal_code', $holderHakcipta->postal_code) }}">
                                    </div>
                                ...
                                <div class="col-md-8 form-group">
                                    <input class="form-check-input" type="checkbox" id="is_company" name="is_company" @checked(old('is_company', $holderHakcipta->is_company))>
...
<script>
    ...
    var selected_district = "{{ old('district_id', $holderHakcipta->district_id) }}";
    function provinceFuncAction() {
        var province = $('#province_id').val();
        if (province != "") {
            var url = "{{ url('/ajuan/') }}"+"/"+_detail+"/pemegang/generate/district/"+province;
            $.ajax({
                url: url,
                type:'POST',
                data: {
    ...
    var selected_subdistrict = "{{ old('subdistrict_id', $holderHakcipta->subdistrict_id) }}";
    function districtFuncAction(status = "") {
        ...
        if (district != "") {
            var url = "{{ url('/ajuan/') }}"+"/"+_detail+"/pemegang/generate/subdistrict/"+district;
            $.ajax({
                url: url,
                type:'POST',
                data: {
